...
-As perguntas devem abranger os pontos principais do texto, incentivando o raciocínio sem serem excessivamente complexas.
...
const loader = YoutubeLoader.createFromUrl("https://www.youtube.com/watch?v=WULwZ6v_Ai8&t=12s", {
    language: "en",
    addVideoInfo: true,
  });
